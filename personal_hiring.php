        ...
        <div class="container-fluid profile-background d-none d-sm-block profile">
            <div class="row pt-5">
                ...
                <div class="col-3 ms-5 bg-dark rounded shadow pb-3">
                    <form action="personal_hiring_page.php" method="post">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea name="ph_title" id="" rows="1" class='form-control' required>Project for <?php echo "".$record["user_first_name"]." ".$record["user_last_name"]."";?></textarea>
                            <label for="" class='text-white pb-2 fw-bold mt-4'>Send a private message</label>
                            <textarea name="ph_description" id="" rows="3" class='form-control' required>Hi <?php echo "".$record["user_first_name"]." ".$record["user_last_name"]."";?>, I noticed your profile and would like to offer you my project.</textarea>
                            <h4 class="text-light mt-3">What is your Budget ?</h4>
                            <div class="row pb-2">
                                <div class="col text-light">
                                    ...
                                    <div class="input-group mt-3">
                                        ...
                                        <input type="number" class="form-control" name='ph_amount' id="mindemo" value=""
                                            placeholder="0" value="" style="border-left: 0px; border-right: 0px;" required>
                                        <span class="input-group-text bg-white"
                    ...
                    <input type="number" name="phid_freelancer_id" value="<?php echo $uid_select ?>" class="d-none">
                    
                    <div class="row mt-4">
                        <div class="col">
                            <input type="submit" class='btn btn-primary form-control fw-bold' name="personal_hiring" value="Hire <?php echo "".$record["user_first_name"]." ".$record["user_last_name"]."";?>">
                        </div>
                    </div>
